...
class Concept:
	...
	def __str__(self):
		ret = self.name
		return ret	
	def __repr__(self): #this is not a standard use of repr but it will help with printing lists (https://docs.python.org/3.4/library/functions.html?highlight=repr#repr)
		return str(self)
